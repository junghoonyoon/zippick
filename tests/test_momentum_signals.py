...
class MomentumSignalsTest(unittest.TestCase):
    ...
    def test_attach_signals_sets_leader_gap_and_badges(self):
        ...
        self.assertEqual(chaser["leaderBasis"], "district_84m2_actual_price_v9")
    ...
    def test_leader_is_fixed_from_entire_district_when_not_in_search_results(self):
        ...
        self.assertEqual(signals["leaderBasis"], "district_84m2_actual_price_v9")
    ...
    def test_locality_leader_excludes_wide_non_84m2_complex(self):
        def fake_tx(name, **kwargs):
            if name == "한양아파트":
        ...
        self.assertEqual(signals["leaderBasis"], "locality_84m2_actual_price_v9")
        self.assertTrue(signals["isRegionalLeader"])

    def test_non_84m2_trade_is_not_adjusted_into_leader_price(self):
        small = {"exclusiveArea": 59.8, "dealAmountManwon": 150000}
        large = {"exclusiveArea": 84.8, "dealAmountManwon": 190000}

        self.assertIsNone(momentum_signals.apartment_leaders._leader_adjusted_price(small, 84))
        self.assertEqual(momentum_signals.apartment_leaders._leader_adjusted_price(large, 84), 190000)

    def test_leader_reference_price_uses_only_actual_84m2_trades(self):
        deals = [
